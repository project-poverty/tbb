...
<br><br>   
        <div class="button">
            <button type="button" name="partners" class="btn btn-warning"><a href="https://en.wikipedia.org/wiki/The_Bottom_Billion#Synopsis" target="_blank">LEARN MORE</a></button>
<br><br>     
        </div>
